			...
			<ol class="property-list alumno">
				...
				<li class="fieldcontain">
					<span id="curso-label" class="property-label"><g:message code="alumno.curso.label" default="Curso" /></span>
						...
						<span class="property-value" aria-labelledby="curso-label"><g:link controller="curso" action="show_alumno" id="${alumnoInstance?.curso?.id}">${alumnoInstance?.curso?.encodeAsHTML()}</g:link></span>
